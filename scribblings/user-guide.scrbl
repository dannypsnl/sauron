...
@itemlist[
 ...
 ;;; jump to definition
 @item{@litchar{c+b} or @litchar{<click>} jump to definition if cursor is on a reference/binding; open a list-box to let you pick a reference if cursor is on a definition}
